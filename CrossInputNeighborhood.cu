...
static int cunn_CrossInputNeighborhood_updateOutput(lua_State *L) {
	...
	//printf("in cunn: input size %d x %d x %d \n", inputLayers, inputWidth, inputHeight);
...
static int cunn_CrossInputNeighborhood_updateGradInput(lua_State *L) {
	...
	//fields
	THCudaTensor *gradOutput1 = (THCudaTensor*) luaT_getfieldcheckudata(L, 1, "gradOutput1", "torch.CudaTensor");
	THCudaTensor *gradOutput2 = (THCudaTensor*) luaT_getfieldcheckudata(L, 1, "gradOutput2", "torch.CudaTensor");
...
static const struct luaL_Reg cunn_CrossInputNeighborhood__[] = {
		{ "CrossInputNeighborhood_updateOutput", cunn_CrossInputNeighborhood_updateOutput },
		{ "CrossInputNeighborhood_updateGradInput",	cunn_CrossInputNeighborhood_updateGradInput },
		{ NULL, NULL }
};

void cunn_CrossInputNeighborhood_init(lua_State *L) {
	luaT_pushmetatable(L, "torch.CudaTensor");
	luaT_registeratname(L, cunn_CrossInputNeighborhood__, "nn");
	lua_pop(L, 1);
}
